...
sessions$mes <- factor(sessions$mes, levels = c("January", "Feburary",
                                                "March", "Abril",
                                                "May", "June",
                                                "July", "August",
...
What usage pattern do we predit for next week? This can be a useful question to ask if you are putting a feature in production that you expect to increase user sessions. Using a forecast algoritnm like the Holt-Winters method will take into account peaks and troughs to give you a better picture of whether your change has made an impact.
...
ee <- ee + scale_fill_gradientn(colours = heat_scale)
